...
module Carbon {
  ...
  var Util = {
    getRelativePositionX: function(x: number, relativeElement) {
  ...
  class Rail {
    ...
    startDrag(e) {
      ...
      this.baseY = parseInt($(this.handleEl).css('top'), 10);
  ...
  export class Scrollable {
    ...
    constructor(element: HTMLElement, options = { }) {
      ...
      var railEl = <HTMLElement>this.element.querySelector('carbon-scrollbar, .rail');
