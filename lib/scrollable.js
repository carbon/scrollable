...
(function (Carbon) {
    ...
    var Scrollbar = (function () {
        ...
        Scrollbar.prototype.endDrag = function (e) {
            UserSelect.unblock();
            this.dragging = false;
            this.update(e);
        ...
        Scrollbar.prototype.update = function (e) {
            if (e.type == 'mousemove') {
        ...
        Scrollbar.prototype.setPercent = function (p) {
    ...
    var Scrollable = (function () {
        function Scrollable(element, options) {
            ...
            var scrollBarEl = this.element.querySelector('.scrollbar');
